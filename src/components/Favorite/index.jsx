...
const Favorite = ({ id, title, description, image, share, sharePrice, price, maxWeight }) => {
      ...
      <article className={`${styles.item} flex f-d-col rel`}>
        <div className={`${styles.top} flex al-f-s jus-n`}>
          <button
            ...
            className={`${styles.like} ${styles.like_2} rel z-5 flex f-cen`}
            type="button"
          >
        ...
        <div className={`${styles.bottom} flex al-c jus-b gap-5`}>
          ...
          <div className={`${styles.prices} flex f-d-col al-c`}>
            {share && <del className={`${styles.old_price} al-s-n`}>{sharePrice} ₽ </del>}
